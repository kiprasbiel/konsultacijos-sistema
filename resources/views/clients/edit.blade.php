...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col">
                <h1>Redaguoti klientą <strong>{{$client->name}}</strong></h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {{Form::text('code', $client->code, ['class' => 'form-control'])}}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    {{Form::label('company_reg_date', 'Įmonės registracijos data')}}
                    {{Form::date('company_reg_date', $client->company_reg_date, ['class' => 'form-control'])}}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {{Form::select('reg_county', $county_list, $client->reg_county, ['class' => 'select2 form-control', 'placeholder' => "Pasirinkite savivaldybę"])}}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="row aw-text-area-180">
            <div class="col-md-6">
                ...
                {{Form::textarea('contacts', $client->contacts, ['class' => 'form-control', 'style' => 'height: 30%'])}}
            </div>
        </div>

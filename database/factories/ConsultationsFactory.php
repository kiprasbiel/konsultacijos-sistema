...
$factory->state(Consultation::class, 'ECO', function (Faker $faker){
    return [
        'theme_id' => $faker->numberBetween(1, 5),
    ];
});

$factory->state(Consultation::class, 'EXPO', function (Faker $faker){
    return [
        'theme_id' => $faker->numberBetween(6, 11),
    ];
});

$factory->state(Consultation::class, 'VKT', function (Faker $faker){
    return [

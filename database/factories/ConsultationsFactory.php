...
$factory->defineAs(Consultation::class,'ECO', function (Faker $faker) {
    $client_id = Client::get('id')->toArray();
    $formatted_client_ids = array_column($client_id, 'id');
...
$factory->defineAs(Consultation::class,'EXPO', function (Faker $faker) {
    $client_id = Client::get('id')->toArray();
    $formatted_client_ids = array_column($client_id, 'id');
    ...
    return [
        ...
        'user_id' => $faker->randomElement($formatted_user_ids),
        'contacts' => $faker->email,
        'theme_id' => $faker->numberBetween(6, 11),
        'address' => $faker->streetAddress,
        'consultation_date' => $weekAfter,
        'consultation_length' => $faker->time(),
        'Method' => $faker->randomElement(['Skype', 'Telefonu', 'Vietoje']),
...
$factory->defineAs(Consultation::class,'VKT', function (Faker $faker) {
    $client_id = Client::get('id')->toArray();
    $formatted_client_ids = array_column($client_id, 'id');
    ...
    return [
        ...
        'user_id' => $faker->randomElement($formatted_user_ids),
        'contacts' => $faker->email,
        'theme_id' => $faker->numberBetween(12, 30),
        'address' => $faker->streetAddress,
        'consultation_date' => $weekAfter,
        'consultation_length' => $faker->time(),
        'Method' => $faker->randomElement(['Skype', 'Telefonu', 'Vietoje']),
